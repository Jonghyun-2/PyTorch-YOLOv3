...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_def", type=str, default="config/yolov3_sign.cfg", help="path to model definition file")
    parser.add_argument("--data_config", type=str, default="config/sign.data", help="path to data config file")
    parser.add_argument("--pretrained_weights", type=str, default=r'./weights/darknet53.conv.74', help="if specified starts from checkpoint model")
